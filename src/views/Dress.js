...
return(
	...
	<header>
		...
		<div className='btnbox'>
			<span className='active dianji' onClick={()=>this.checkout("服装类",1)}>服装</span>
			<span className='dianji' onClick={()=>this.checkout("运动鞋",2)}>运动鞋</span>
			<span className='dianji' onClick={()=>this.checkout("服饰",3)}>服饰</span>
			<span className='dianji' onClick={()=>this.checkout("箱包",4)}>箱包</span>
		</div>
