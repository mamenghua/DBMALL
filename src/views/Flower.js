...
return(
	...
	<header>
		...
		<div className='btnbox'>
			<span className='active dianji' onClick={()=>this.checkout("时尚花卉",1)}>综合</span>
			<span className='dianji' onClick={()=>this.checkout("开业花篮",2)}>开业花篮</span>
			<span className='dianji' onClick={()=>this.checkout("康乃馨",3)}>康乃馨</span>
			<span className='dianji' onClick={()=>this.checkout("玫瑰",4)}>玫瑰</span>
			<span className='dianji' onClick={()=>this.checkout("巧克力",5)}>巧克力</span>
		</div>
