...
return(
	...
	<header>
		...
		<div className='btnbox'>
			<span className='active dianji' onClick={()=>this.checkout("手机",1)}>综合</span>
			<span className='dianji' onClick={()=>this.checkout("华为",2)}>华为</span>
			<span className='dianji' onClick={()=>this.checkout("三星",3)}>三星</span>
			<span className='dianji' onClick={()=>this.checkout("努比亚",4)}>努比亚</span>
			<span className='dianji' onClick={()=>this.checkout("Apple",5)}>Apple</span>
			<span className='dianji' onClick={()=>this.checkout("荣耀",6)}>荣耀</span>
			<span className='dianji' onClick={()=>this.checkout("realme",7)}>realme</span>
			<span className='dianji' onClick={()=>this.checkout("OPPO",7)}>OPPO</span>
		</div>
